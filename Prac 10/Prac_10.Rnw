...
mm <- matrix(c(0.73,0.5,0.5,0.8),4,4,byrow=TRUE)
...
During the lectures, you have seen how to combine these two matrices efficiently using a vec-permutation matrix, \boldsymbol{P}.


A mathematical efficient way to write this matrix is: 
\begin{align*}
...
Can you write a code that calculate \boldsymbol{P}?
