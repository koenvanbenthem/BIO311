...
\end{alltt}
\begin{verbatim}
##  [1] 26 27 35 36 36 32 34 29 39 32
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{align*}\boldsymbol{B_1} &=% latex table generated in R 3.2.3 by xtable 1.8-2 package
% Sat Mar 12 22:22:57 2016
\begin{pmatrix}{}
  0.00 & 0.25 \\ 
  0.72 & 0.77 \\ 
  \end{pmatrix}
& \boldsymbol{B_2} &=% latex table generated in R 3.2.3 by xtable 1.8-2 package
% Sat Mar 12 22:22:57 2016
\begin{pmatrix}{}
  0.00 & 0.32 \\ 
  0.74 & 0.79 \\ 
...
\begin{align*}\boldsymbol{B} &=% latex table generated in R 3.2.3 by xtable 1.8-2 package
% Sat Mar 12 22:22:57 2016
\begin{pmatrix}{}
  0.00 & 0.25 & 0.00 & 0.00 \\ 
  0.72 & 0.77 & 0.00 & 0.00 \\ 
...
\begin{align*}\boldsymbol{M_j} &=% latex table generated in R 3.2.3 by xtable 1.8-2 package
% Sat Mar 12 22:22:58 2016
\begin{pmatrix}{}
  0.73 & 0.50 \\ 
  0.27 & 0.50 \\ 
  \end{pmatrix}
...
\begin{align*}\boldsymbol{M_a} &=% latex table generated in R 3.2.3 by xtable 1.8-2 package
% Sat Mar 12 22:22:58 2016
\begin{pmatrix}{}
  0.50 & 0.20 \\ 
  0.50 & 0.80 \\ 
...
\begin{align*}\boldsymbol{M} &=% latex table generated in R 3.2.3 by xtable 1.8-2 package
% Sat Mar 12 22:22:58 2016
\begin{pmatrix}{}
  0.73 & 0.50 & 0.00 & 0.00 \\ 
  0.27 & 0.50 & 0.00 & 0.00 \\ 
...
This task is not absolutely trivial because $\boldsymbol{M}$ is organized by age, while $\boldsymbol{B}$ is organized by site. 

During the lectures, you have seen how one can use matrix algebra to efficiently obtain this meta-population matrix, using a vec-permutation matrix, \boldsymbol{P}.
...
\begin{verbatim}
##      [,1]   [,2]  [,3]  [,4]
## [1,] 0.00 0.1825 0.000 0.160
## [2,] 0.36 0.3850 0.148 0.158
## [3,] 0.00 0.0675 0.000 0.160
## [4,] 0.36 0.3850 0.592 0.632
\end{verbatim}
\begin{alltt}
...
## 
## $stable.stage
## [1] 0.1284145 0.2362844 0.1012739 0.5340271
## 
## $sensitivities
##           [,1]      [,2]      [,3]      [,4]
## [1,] 0.0000000 0.1780902 0.0000000 0.4025022
## [2,] 0.1280537 0.2356205 0.1009893 0.5325265
## [3,] 0.0000000 0.1883674 0.0000000 0.4257297
## [4,] 0.1411180 0.2596589 0.1112924 0.5868559
## 
## $elasticities
##            [,1]       [,2]       [,3]       [,4]
## [1,] 0.00000000 0.03246311 0.00000000 0.06432435
## [2,] 0.04604493 0.09060683 0.01492878 0.08403991
## [3,] 0.00000000 0.01269979 0.00000000 0.06803637
## [4,] 0.05074253 0.09985072 0.06580738 0.37045529
## 
## $repro.value
## [1] 1.000000 1.323040 1.057708 1.458019
## 
## $damping.ratio
## [1] 3.623132
\end{verbatim}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): objet 'Asens' introuvable}}\begin{alltt}
...
\hlkwa{for} \hlstd{(i} \hlkwa{in} \hlnum{1}\hlopt{:}\hlstd{s)\{}
        ...
        \hlstd{P}\hlkwb{<-}\hlstd{P}\hlopt{+}\hlstd{E}\hlopt{%x%}\hlkwd{t}\hlstd{(E)} \hlcom{# %x% is the Kronecker product}
        \hlstd{\}\}}
