...
What are the two (at least) assumptions you had to make to do so? % ratio of population sizes + timing of reproduction VS. migration
...
During the lectures, you have seen how to combine these two matrices efficiently using a vec-permutation matrix, \boldsymbol{P}, such as: 
