...
\end{alltt}
\begin{verbatim}
##  [1] 40 41 31 27 28 35 27 37 29 40
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\caption{\label{fig:peregrine}One of these birds is a peregrine falcon in a dive attack, the other birds are starlings and in trouble. Populations of peregrine falcons, and many other bird species, have declined during the 20th century in North America and Europe, in particular as a result of the massive use of the insecticide dichlorodiphenyltrichloroethane. DDT, which causes eggshell thinning, has been banned from these regions but is still used in tropical regions. Picture by Rob Palmer.}
\end{figure}

Let us consider two populations of peregrine falcons. 
The demography of the two populations is summarized by the Leslie matrices $A_1$ and $A_2$ and by the associated asymptotic growth rates:
\begin{align*}\boldsymbol{B_1} &=% latex table generated in R 3.2.3 by xtable 1.8-0 package
% Fri Mar 11 13:53:58 2016
\begin{pmatrix}{}
  0.00 & 0.25 \\ 
  0.72 & 0.77 \\ 
  \end{pmatrix}
...
## [3,] 0.00 0.00 0.00 0.32
## [4,] 0.00 0.00 0.74 0.79
\end{verbatim}
\begin{alltt}
...
\begin{verbatim}
##       [,1]   [,2]  [,3]   [,4]
## [1,] 0.000 0.1825 0.000 0.0864
## [2,] 0.360 0.3850 0.370 0.3950
## [3,] 0.000 0.1250 0.000 0.1600
## [4,] 0.144 0.1540 0.592 0.6320
\end{verbatim}
\begin{alltt}
...
## 
## $stable.stage
## [1] 0.1057359 0.3879402 0.1124745 0.3938494
## 
## $sensitivities
##            [,1]      [,2]       [,3]      [,4]
## [1,] 0.00000000 0.1797919 0.00000000 0.1825306
## [2,] 0.07608703 0.2791599 0.08093612 0.2834122
## [3,] 0.00000000 0.4265926 0.00000000 0.4330906
## [4,] 0.14716212 0.5399311 0.15654089 0.5481556
## 
## $elasticities
##            [,1]       [,2]       [,3]       [,4]
## [1,] 0.00000000 0.03309631 0.00000000 0.01590728
## [2,] 0.02762864 0.10840770 0.03020581 0.11291770
## [3,] 0.00000000 0.05378606 0.00000000 0.06989486
## [4,] 0.02137494 0.08386979 0.09347510 0.34943581
## 
## $repro.value
## [1] 1.000000 1.552683 2.372701 3.003089
## 
## $damping.ratio
## [1] 3.51128
\end{verbatim}
