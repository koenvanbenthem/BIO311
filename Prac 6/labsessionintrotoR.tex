...
{\centering \includegraphics[width=0.5\textwidth]{figure/ploti-1} 
...
{\centering \includegraphics[width=0.5\textwidth]{figure/ploti2-1} 
...
{\centering \includegraphics[width=0.75\textwidth]{figure/ploti3-1} 
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in library(sciplot): there is no package called 'sciplot'}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): could not find function "{}lineplot.CI"{}}}\end{kframe}
\end{knitrout}
\end{mdframed}
