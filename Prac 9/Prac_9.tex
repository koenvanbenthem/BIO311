...
\end{kframe}
\end{knitrout}
This means that after $40$ years, $48\% $ of the total population will have originated from the two individuals that were initially in age class $1$, $25\% $ from the individual in age class $2$ and the remaining $26\% $ of the total population at timestep $40$ from the individual that was in age class $3$ in the initial population. These numbers do not correspond to the left eigenvector, yet they do relate to the left eigenvalue.
