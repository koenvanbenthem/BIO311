...
\begin{verbatim}
##          [,1]      [,2]     [,3]
## [1,] 2.178226 3.4971162 2.319496
## [2,] 2.276421 3.8959946 3.774394
## [3,] 3.788442 0.7960238 3.114312
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## [1] 0.3281938+0i 0.3117589+0i 0.3600473+0i
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## [1] 0.3281938 0.3117589 0.3600473
\end{verbatim}
\begin{alltt}
...
\end{kframe}
\end{knitrout}
You can interpret this as follows: if we for example start with a population $\begin{pmatrix}1\\ 1\\ 1 \end{pmatrix}$, after $40$ years, $33\% $ of the total population will have originated from the individual that was initially in age class $1$, $31\% $ from the individual in age class $2$ and the remaining $36\% $ of the total population at timestep $40$ from the individual that was in age class $3$ in the initial population.
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
## [1] 0.4941957 0.2347240 0.2710804
\end{verbatim}
\end{kframe}
\end{knitrout}
This means that after $40$ years, $49\% $ of the total population will have originated from the two individuals that were initially in age class $1$, $23\% $ from the individual in age class $2$ and the remaining $27\% $ of the total population at timestep $40$ from the individual that was in age class $3$ in the initial population. These numbers do not correspond to the left eigenvector, yet they do relate to the left eigenvalue.
First we need to realize that if $49\% $ of the final population originated from the two individuals in age class 1 in the initial population, this means that each of these two individuals is responsible for $24.5\% $ of the final population. It is of course fairer to compare these numbers with each other (so after correcting for the number of individuals that we started with):
\begin{equation*}
\begin{pmatrix}
24.5 \\
23 \\
...
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/LTRE_FACT-3} 
\begin{kframe}\begin{alltt}
\hlcom{## Summary}
