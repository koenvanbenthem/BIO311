...
\begin{verbatim}
##           [,1]      [,2]      [,3]
## [1,] 0.7065403 1.1137356 0.4195131
## [2,] 1.9505753 2.8367538 2.7158272
## [3,] 2.4073581 0.6070039 1.0202562
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## [1] 0.3596799+0i 0.3383311+0i 0.3019890+0i
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## [1] 0.3596799 0.3383311 0.3019890
\end{verbatim}
\begin{alltt}
...
\end{kframe}
\end{knitrout}
You can interpret this as follows: if we for example start with a population $\begin{pmatrix}1\\ 1\\ 1 \end{pmatrix}$, after $40$ years, $36\% $ of the total population will have originated from the individual that was initially in age class $1$, $34\% $ from the individual in age class $2$ and the remaining $30\% $ of the total population at timestep $40$ from the individual that was in age class $3$ in the initial population.
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
## [1] 0.5290656 0.2488314 0.2221030
\end{verbatim}
\end{kframe}
\end{knitrout}
This means that after $40$ years, $53\% $ of the total population will have originated from the two individuals that were initially in age class $1$, $25\% $ from the individual in age class $2$ and the remaining $22\% $ of the total population at timestep $40$ from the individual that was in age class $3$ in the initial population. These numbers do not correspond to the left eigenvector, yet they do relate to the left eigenvalue.
