...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcom{#Rot <- read.csv("/Users/koen/Documents/Given Courses/BIO311/Prac 9/rotifer_data.csv")[,2:9]}
\hlstd{Rot} \hlkwb{<-} \hlkwd{read.csv}\hlstd{(}\hlstr{"rotifer_data.csv"}\hlstd{)[,}\hlnum{2}\hlopt{:}\hlnum{9}\hlstd{]}
