...
\begin{verbatim}
##            [,1]      [,2]       [,3]
## [1,] 0.03647354 1.6312533 0.55656309
## [2,] 0.45934128 0.1478964 0.03347026
## [3,] 0.18124954 3.8780935 3.68049853
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## [1] 0.08002004 0.48969268 0.43028728
\end{verbatim}
\begin{alltt}
...
\end{kframe}
\end{knitrout}
You can interpret this as follows: if we for example start with a population $\begin{pmatrix}1\\ 1\\ 1 \end{pmatrix}$, after $40$ years, $8\% $ of the total population will have originated from the individual that was initially in age class $1$, $49\% $ from the individual in age class $2$ and the remaining $43\% $ of the total population at timestep $40$ from the individual that was in age class $3$ in the initial population.
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
## [1] 0.1481825 0.4534107 0.3984068
\end{verbatim}
\end{kframe}
\end{knitrout}
This means that after $40$ years, $15\% $ of the total population will have originated from the two individuals that were initially in age class $1$, $45\% $ from the individual in age class $2$ and the remaining $40\% $ of the total population at timestep $40$ from the individual that was in age class $3$ in the initial population. These numbers do not correspond to the left eigenvector, yet they do relate to the left eigenvalue.
First we need to realize that if $15\% $ of the final population originated from the two individuals in age class 1 in the initial population, this means that each of these two individuals is responsible for $7.5\% $ of the final population. It is of course fairer to compare these numbers with each other (so after correcting for the number of individuals that we started with):
\begin{equation*}
\begin{pmatrix}
7.5 \\
45 \\
