...
\begin{equation*} 
c_1 = \Sexpr{round(n[1]/(v1[1]),2)} - \Sexpr{round(v2[1]/v1[1],2)} \cdot c_2 = \Sexpr{round(n[1]/v1[1] - c22*v2[1]/v1[1],2)}
\end{equation*}
<<setc1,include=FALSE>>=
...
\begin{equation*}
\Sexpr{round(c11,2)} \cdot \begin{pmatrix} \Sexpr{round(v1[1],2)} \\ \Sexpr{round(v1[2],2)} \end{pmatrix} + \Sexpr{round(c22,2)} \cdot \begin{pmatrix} \Sexpr{round(v2[1],2)} \\ \Sexpr{round(v2[2],2)} \end{pmatrix} = \begin{pmatrix} \Sexpr{(c11 * v1 + c22 * v2)[1]} \\ \Sexpr{(c11 * v1 + c22 * v2)[2]} \end{pmatrix}
\end{equation*}
<<calcN,include=FALSE>>=
c1 * v1 + c2 * v2
@
